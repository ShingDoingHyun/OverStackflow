...
<body>
	...
	<div class="main">
		...
		<div class="sidenav2">
			<span class="left_select"><strong>지원관리</strong></span> <a
				 href="memberUpdate">이력서 관리</a> <a href="memberAppList" >내가 지원한 목록</a> <a
				href="memberInterestComList" style="color: black">관심기업</a><a href="memberInterestAppComList">즐겨찾기한 채용 공고</a>
		</div>
		<div class="main_2">
			<div style="margin-top: 20px;"></div>
			<h3>즐겨찾기한 채용 공고</h3>
	...
	<table class="insert">
					<tr>
						<th class="title">즐겨찾기한 채용 공고 목록</th>
					</tr>
